...
export COMPILEFLAGS="-O3 -c -I $OSXINC -I ../libatomic_ops/src -I include -Wno-deprecated-declarations -Wno-unknown-attributes -Wno-builtin-requires-header -fPIC $COMMONFLAGS  -D_REENTRANT"
rm *.o 
